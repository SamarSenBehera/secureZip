...
import { Download, CheckCircle, ArrowRight, FilePlus2Icon as FileSplit2 } from "lucide-react"
        ...
        <section className="bg-gradient-to-b from-primary-50 to-white py-16">
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-4xl font-bold tracking-tight mb-4">Split Complete!</h1>
              <p className="text-lg text-gray-600">
                Your file has been successfully split into {files.length} parts using our DKD algorithm.
              </p>
            </div>
          </div>
        </section>
