...
import { Download, CheckCircle, ArrowRight, FileKey } from "lucide-react"
...
export default function EncryptResultPage() {
        ...
        <section className="bg-gradient-to-b from-primary-50 to-white py-16">
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-4xl font-bold tracking-tight mb-4">Encryption Complete!</h1>
              <p className="text-lg text-gray-600">
                Your {files.length > 1 ? `${files.length} files have` : "file has"} been successfully encrypted using
                our DKD algorithm.
              </p>
            </div>
          </div>
                ...
                <div key={file.id} className="mb-8 rounded-xl border border-primary-100 bg-white p-8 shadow-lg">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-between items-center border-b border-primary-100 pb-4">
                      ...
                      <span className="font-medium text-green-600">Military-grade (DKD)</span>
                    </div>
